...
/**
 * Base class that represents a row from the 'push_token' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class PushToken implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Push\\Model\\Map\\PushTokenTableMap';
    ...
    /**
     * Initializes internal state of Push\Model\Base\PushToken object.
     */
    ...
    /**
     * Compares this with another <code>PushToken</code> instance.  If
     * <code>obj</code> is an instance of <code>PushToken</code>, delegates to
     * <code>equals(PushToken)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 5; // 5 = PushTokenTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Push\\Model\\PushToken'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPushTokenQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PushToken::setDeleted()
     * @see PushToken::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPushTokenQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PushTokenTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO push_token (%s) VALUES (%s)',
    ...
    {
        $pos = PushTokenTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['PushToken'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Push\Model\PushToken
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Push\Model\PushToken The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Push\Model\PushToken (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Push\Model\PushToken Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PushTokenTableMap::DEFAULT_STRING_FORMAT);
    }
